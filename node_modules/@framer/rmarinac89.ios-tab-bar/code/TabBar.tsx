...
import Icon from "../code/IconGenerator";
...
interface Props {
  ...
  set: "feather" | "material" | "ionicons" | "fontawesome";
}

export class TabBar extends React.Component<Props> {
  // constructor(props) {
  //   super(props);
  //   this.state = { height: 83, width: 375 };
  // }
  ...
  render() {
    ...
    for (var index = 0; index < Tabs; index++) {
      ...
      items.push(
        <TabIcon style={width > 767 ? { width: "100%" } : { width: 49 }}>
          <Icon
